        ...
        <thead>
          <tr className="border-b border-white/10">
            ...
            >
              <input
                type="checkbox"
                className="size-4 bg-black/20 rounded-md border border-white/10"
              />
            </TableHeader>
            <TableHeader>Código</TableHeader>
            <TableHeader>Partictipantes</TableHeader>
              ...
              <TableRow key={attendee.id}>
                ...
                <TableCell>
                  {attendee.checkedInAt === null ? (
                    ...
                    dayjs(attendee.checkedInAt).to(attendee.checkedInAt)
                  )}
                </TableCell>
                <TableCell>
